...
public class CashOfficeTestApplication2 {

	private static final Logger LOGGER = LogManager.getLogger(CashOfficeTestApplication2.class);

	public static void main(String[] args) {
		SpringApplication.run(CashOfficeTestApplication2.class, args);		
	}
